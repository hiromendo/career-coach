...
# --- App Title ---
st.title("🛠️ Operational Improvement Proposal Helper")
st.markdown("""
This tool helps you identify an operational inefficiency in your current role (e.g., Mail Handler)
...
if inefficiency and current_workflow and proposed_solution and proposed_workflow:
    ...
    * **Visualize:** Consider creating a simple visual workflow diagram (Before vs. After) using tools like:
        * Microsoft PowerPoint (SmartArt)
        * [draw.io](https://app.diagrams.net/) (Free online tool)
        * Lucidchart
        This visual representation is a powerful way to communicate your idea.
    ...
    * **Connect the Skills:** This exercise directly demonstrates skills relevant to the Operations Specialist role:
        ...
        * **Process Improvement:** You outlined a better workflow.
        * **Communication:** You articulated the problem and solution (and could visualize it).
        * **Attention to Detail:** Describing the workflow steps requires careful thought.
    ...
    st.info("Complete steps 1-5 above to generate your improvement proposal summary.")
