...
# --- Page Definitions ---
page_configs = [
    {"module": "1_Introduction.py", "title": "Introduction"},
    {"module": "2_Introduction_Report_Objectives.py", "title": "Objectives"},
    {"module": "3_Potential_Career_Paths.py", "title": "Potential Career Paths"},
    {"module": "5_Transferable_Skills.py", "title": "Transferable Skills"},
    {"module": "6_Skills_Synthesized_Value.py", "title": "Skills Synthesized Value"},
    {"module": "7_Logistics_Coordinator.py", "title": "Logistics Coordinator"},
    {"module": "8_Operational_Specialist.py", "title": "Operational_Specialist"},
    {"module": "9_Project_Coordinator.py", "title": "Project Coordinator"},
    {"module": "10_Conclusion.py", "title": "Conclusion"},
]
